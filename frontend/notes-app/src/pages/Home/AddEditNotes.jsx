...
const AddEditNotes = ({noteData, type, getAllNotes, onClose, showToastMessage}) => {
    ...
    return (
        <div className='relative'>
            <button className="w-10 h-10 rounded-full flex items-center justify-center absolute -to-3 -right-3 hover:bg-slate-500" onClick={onClose}>
            ...
            <div className="flex flex-col gap-2">
                ...
                <input
                    ...
                    placeholder="Go To Gym At 9:00 AM"
                    value={title}
